...
wire LEDGPIO_en;
wire LEDIRQ_O;
output [2-1:0] LEDPIO_OUT;

wire [7:0] SPIFlashS_DAT_O;
wire   SPIFlashS_ACK_O;
wire   SPIFlashS_ERR_O;
wire   SPIFlashS_RTY_O;
wire SPIFlashS_en;
wire [7:0] SPIFlashC_DAT_O;
wire   SPIFlashC_ACK_O;
wire   SPIFlashC_ERR_O;
wire   SPIFlashC_RTY_O;
wire SPIFlashC_en;
output  SPIFlashCEJ;
output  SPIFlashSCK;
output  SPIFlashSI;
...
SPIFlashS_en ? {4{SPIFlashS_DAT_O[7:0]}} : 
SPIFlashC_en ? {4{SPIFlashC_DAT_O[7:0]}} : 
0;
assign SHAREDBUS_ERR_O = SHAREDBUS_CYC_I & !(
(!LEDGPIO_ERR_O & LEDGPIO_en) | 
(!SPIFlashS_ERR_O & SPIFlashS_en) | 
(!SPIFlashC_ERR_O & SPIFlashC_en) | 
0);
assign SHAREDBUS_ACK_O = 
LEDGPIO_en ? LEDGPIO_ACK_O : 
SPIFlashS_en ? SPIFlashS_ACK_O : 
SPIFlashC_en ? SPIFlashC_ACK_O : 
0;
assign SHAREDBUS_RTY_O = 
LEDGPIO_en ? LEDGPIO_RTY_O : 
SPIFlashS_en ? SPIFlashS_RTY_O : 
SPIFlashC_en ? SPIFlashC_RTY_O : 
0;
lm8 
#(
.CFG_REGISTER_16(0),
...
.CFG_CALL_STACK_32(0),
.CFG_PROM_SIZE(2048),
.CFG_PROM_INIT_FILE("C:/Users/Suhail/Desktop/Work/Machxo2_SPI/prom_init.mem"),
.CFG_PROM_INIT_FILE_FORMAT("hex"),
.SP_BASE_ADDRESS(32'h0),
.SP_SIZE(2048),
.SP_PORT_ENABLE(1),
.CFG_SP_INIT_FILE("C:/Users/Suhail/Desktop/Work/Machxo2_SPI/scratchpad_init.mem"),
...
wire [7:0] SPIFlashS_DAT_I;
assign SPIFlashS_DAT_I = SHAREDBUS_DAT_I[7:0];
wire [7:0] SPIFlashC_DAT_I;
assign SPIFlashC_DAT_I = SHAREDBUS_DAT_I[7:0];
wire [0:0] SPIFlashS_SEL_I;
assign SPIFlashS_SEL_I = SHAREDBUS_SEL_I;
wire [0:0] SPIFlashC_SEL_I;
assign SPIFlashC_SEL_I = SHAREDBUS_SEL_I;
assign SPIFlashS_en = ( SHAREDBUS_ADR_I[31:24] == 8'b00000001);
assign SPIFlashC_en = ( SHAREDBUS_ADR_I[31:11] == 21'b100000000000000000000);
spi_flash 
#(
.LATTICE_FAMILY("MachXO2"),
.S_WB_DAT_WIDTH(8),
...
.S_DAT_I(SPIFlashS_DAT_I[7:0]),
.S_DAT_O(SPIFlashS_DAT_O[7:0]),
.S_SEL_I(SPIFlashS_SEL_I),
.S_WE_I(SHAREDBUS_WE_I),
.S_ACK_O(SPIFlashS_ACK_O),
.S_ERR_O(SPIFlashS_ERR_O),
.S_RTY_O(SPIFlashS_RTY_O),
.S_CTI_I(SHAREDBUS_CTI_I),
.S_BTE_I(SHAREDBUS_BTE_I),
.S_LOCK_I(SHAREDBUS_LOCK_I),
.S_CYC_I(SHAREDBUS_CYC_I & SPIFlashS_en),
.S_STB_I(SHAREDBUS_STB_I & SPIFlashS_en),
.C_ADR_I(SHAREDBUS_ADR_I[10:0]),
.C_DAT_I(SPIFlashC_DAT_I[7:0]),
.C_DAT_O(SPIFlashC_DAT_O[7:0]),
.C_SEL_I(SPIFlashC_SEL_I),
.C_WE_I(SHAREDBUS_WE_I),
.C_ACK_O(SPIFlashC_ACK_O),
.C_ERR_O(SPIFlashC_ERR_O),
.C_RTY_O(SPIFlashC_RTY_O),
.C_CTI_I(SHAREDBUS_CTI_I),
.C_BTE_I(SHAREDBUS_BTE_I),
.C_LOCK_I(SHAREDBUS_LOCK_I),
.C_CYC_I(SHAREDBUS_CYC_I & SPIFlashC_en),
.C_STB_I(SHAREDBUS_STB_I & SPIFlashC_en),
.CEJ(SPIFlashCEJ),
.SCK(SPIFlashSCK),
.SI(SPIFlashSI),
.SO(SPIFlashSO),
